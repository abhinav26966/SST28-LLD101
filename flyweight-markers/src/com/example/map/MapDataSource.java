...
/**
 * Generates markers for demo/testing. Uses {@link MarkerStyleFactory} so that
 * identical (shape, color, size, filled) combinations share a single
 * {@link MarkerStyle} instance.
 */
